...
//@CucumberOptions(features =  "D://Testing//Testing Mini Bytes//Selenium Framework//Workplace//nopCommerceV001_Cucumber//Features//Customers.feature",
		glue = "stepDefinitions",
		dryRun = false,
		monochrome = true,
		plugin = { "pretty","html:target/Destination/test.html" }
